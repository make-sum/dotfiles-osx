...
# Set computer name
COMPUTERNAME="Amit Rahav's Beautifull Mac"
HOSTNAME='amitsmac'
LOCALHOSTNAME='amitsmac'
...
defaults write -g AppleLanguages -array "en" "he"
defaults write -g AppleLocale -string "en_US@currency=ILS"
